...
final class RequireModuleClasses
{
    ...
    public static function load(): void
    {
        ...
        $files = [
            ...
            $module . '/Snapshot/Medication.php',
            ...
            $module . '/Snapshot/Adapter/MedicationDataSource.php',
            $module . '/Snapshot/Adapter/MedicationAdapter.php',
            $module . '/Snapshot/MedicationProvenance.php',
            $module . '/Snapshot/Adapter/MedicationProvenanceDataSource.php',
            $module . '/Snapshot/Adapter/MedicationProvenanceAdapter.php',
