...
↓
H ‖ I  (parallel post-W2 fast-followers — verifier robustness ‖ guideline corpus expansion, off the critical path)
```
...
- [Phase I — Guideline corpus expansion (CDC, ADA, ACC/AHA, AGS-Beers)](phase-I.md) — post-W2, parallel with H
