...
/**
 * Result of a Tier-3 allergy promotion: the canonical UUID of the new
 * `lists` row that represents the allergy in the chart.
 *
 * `idempotentHit=true` is set when the request collided with an
 * already-persisted allergy keyed on
 * `(sourceDocumentUuid, normalizedSubstance)`. Used by the controller
...
final readonly class AllergyPromotionResult
{
